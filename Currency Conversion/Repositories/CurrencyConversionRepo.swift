...
class CurrencyConversionRepo: CurrencyConversionRepoProtocol {
    func getCurrencies(completion: @escaping (Currencies?, Error?) -> ()) {
        ApiService.shared.getData(url: "https://v6.exchangerate-api.com/v6/ecf10bab01b34bf0de9636e1/codes", method: HTTPMethod.get, parameters: [:], encodingType: URLEncoding.default, headers: [:]) { (Response: Currencies?, Error: Error?) in
